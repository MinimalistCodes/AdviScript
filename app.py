...
# Display Generated Script and other elements in the Main Area
if st.session_state.messages:
    st.markdown("### Generated Script")  # Heading for the script section
    for message in st.session_state.messages:
        if message["role"] == "assistant":
            st.markdown(message["content"])

# Buttons for additional actions (placed outside the form)
